...
import 'package:service_partner/retailer_ui/screens/new_installation_req.dart';
import 'package:service_partner/retailer_ui/screens/new_service_req_screen.dart';
             ...
             child: GridView.count(
               ...
               children: [
                 ...
                 ButtonWidget(
                   ...
                   text: 'New Arrivals',
                   onPressed: () {
                     Navigator.of(context).push(MaterialPageRoute(builder: (context)=> RetailerNewArrivalsScreen()));
                   },
                 ),
                 ButtonWidget(
